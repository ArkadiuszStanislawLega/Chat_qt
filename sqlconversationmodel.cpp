...
QString SqlConversationModel::recipient() const { return this->_recipient; }
...
void SqlConversationModel::set_recipient(const QString &recipient) {
  ...
  const QString filterString =
      QString::fromLatin1("(recipient = '%1' AND author = 'Me') OR (recipient "
                          "= 'Me' AND author = '%1')")
          .arg(this->_recipient);
...
void SqlConversationModel::send_message(const QString &recipient,
